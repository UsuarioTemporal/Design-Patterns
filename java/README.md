...
## **Facade**
El patrón de diseño Facade o en su traduccion como fachada oculta las complejidades del sistema y proporciona una interfaz pra el cliente mediante la cual el cliente puede acceder al sistema.
